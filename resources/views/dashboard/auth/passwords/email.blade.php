                ...
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div style="bottom: 6px" class="col-lg-6 d-lg-block bg-login-image">
                            <img src="{{ asset('assets/admin/img/email.svg') }}" alt="login-image">
                        </div>
                        <div style="top: 50px;" class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Send Email for verification</h1>
                                </div>
