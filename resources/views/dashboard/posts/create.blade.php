@extends('layouts.dashboard.app')@section( 'title','Create Post')
@section('body')
    <br>
    <center>
        <form action="{{ route('admin.posts.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body shadow mb-4 col-10">
                <h2 style="text-align: center">Create New Post <i class="far fa-newspaper"></i></h2><br><br>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <input type="text" name="title" class="form-control" placeholder="Enter Name of User">
                            @error('name')
